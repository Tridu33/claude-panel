...
- 合并 main 分支的单端口 Python 包结构和命令历史功能
- 原生 Windows 自动使用 psmux，WSL/Linux 继续使用 tmux
- 支持 Windows 盘符路径、反斜杠路径和跨平台调试信息

## [1.0.2] - 2026-08-12

### 新功能

- 命令输入框支持通过上、下方向键浏览当前 tmux 会话的命令历史
- 每个会话独立保留最近 50 条命令，并在退出历史浏览时恢复未发送的草稿
